...
import {Walkthrough4} from './walkthroughs/walkthrough4';
import {Walkthrough5} from './walkthroughs/walkthrough5';
import {Walkthrough6} from './walkthroughs/walkthrough6';
  ...
  render() {
    ...
    return (
      <View style={styles.screen}>
        ...
        <PaginationIndicator style={styles.pagination} length={6} current={this.state.index}/>
        <GradientButton
          rkType='large'
          style={styles.button}
          text="GET STARTED"
